        ...
        <div class="row g-5">
          <div class="col-lg-12">
            <div class="main-image thumbnail">
              <img class="radius-small" src="assets/images/course/course-details/course-02.jpg" alt="Banner Images">
            </div>
          </div>
        </div>
                        ...
                        <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                          ...
                          <div class="edu-accordion-body">
                            <ul>
                              ...
                              <li>
                                <div class="text"><i class="icon-draft-line"></i> Local Development Environment Tools
                                </div>
                                <div class="icon"><i class="icon-lock-password-line"></i></div>
                              </li>
                              <li>
                    ...
                    <div class="comment-wrapper pt--40">
                      ...
                      <div class="edu-comment">
                        ...
                        <div class="comment-content">
                          ...
                          <p>As Thomas pointed out, Chegg’s survey appears more like a scorecard that details obstacles
                            and challenges that the current university undergraduate student population is going through
                            in their universities and countries.</p>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="eduvibe-widget">
                  <div class="video-area">
                    <div class="thumbnail video-popup-wrapper">
                      <img class="radius-small w-100" src="assets/images/course/video-bg/course-02.jpg"
                        alt="Course Images">
                  ...
                  <div class="eduvibe-widget-details mt--35">
                    <div class="widget-content">
                      <ul>
                        ...
                        <li><span><img class="eduvibe-course-sidebar-img-icon" src="assets/images/icons/percent.svg"
                              alt="icon Thumb"> Pass Percentage</span><span>90%</span></li>
                  ...
                  <div class="edu-card card-type-3 radius-small">
                    ...
                    <div class="card-hover-action">
                      <div class="hover-content">
                        ...
                        <h6 class="title"><a href="course-details.html">Master Native English Class This Speaking
                            Skills</a></h6>

                        <p class="description">There are many variations of passages of Lorem Ipsaums available, but the
                          majority have suffered alteration. generators on the Internet tend to repeat.</p>
                ...
                <div class="single-slick-card">
                  <div class="edu-card card-type-3 radius-small">
                    <div class="inner">
                      <div class="thumbnail">
                        <a href="course-details.html">
                          <img class="w-100" src="assets/images/course/course-01/course-02.jpg" alt="Course Thumb">
                        </a>
                        <div class="wishlist-top-right">
                          <button class="wishlist-btn"><i class="icon-Heart"></i></button>
                        </div>
                      ...
                      <div class="content">
                        <div class="card-top">
                          <div class="author-meta">
                            <div class="author-thumb">
                              <a href="instructor-profile.html">
                                <img src="assets/images/instructor/instructor-small/instructor-8.jpg" alt="Author Images">
                    ...
                    <div class="card-hover-action">
                      <div class="hover-content">
                        ...
                        <h6 class="title"><a href="course-details.html">The Basic Of Financial Analyst Online Course</a>
                        </h6>
                ...
                <div class="single-slick-card">
                  <div class="edu-card card-type-3 radius-small">
                    <div class="inner">
                      <div class="thumbnail">
                        <a href="course-details.html">
                          <img class="w-100" src="assets/images/course/course-01/course-03.jpg" alt="Course Thumb">
                        </a>
                        <div class="wishlist-top-right">
                          <button class="wishlist-btn"><i class="icon-Heart"></i></button>
                        </div>
                    ...
                    <div class="card-hover-action">
                      <div class="hover-content">
                        ...
                        <h6 class="title"><a href="course-details.html">Introduction to Javascript for The Beginners</a>
                        </h6>
                ...
                <div class="single-slick-card">
                  <div class="edu-card card-type-3 radius-small">
                    <div class="inner">
                      <div class="thumbnail">
                        <a href="course-details.html">
                          <img class="w-100" src="assets/images/course/course-01/course-04.jpg" alt="Course Thumb">
                        </a>
                        <div class="wishlist-top-right">
                          <button class="wishlist-btn"><i class="icon-Heart"></i></button>
                        </div>
                ...
                <div class="single-slick-card">
                  <div class="edu-card card-type-3 radius-small">
                    <div class="inner">
                      <div class="thumbnail">
                        <a href="course-details.html">
                          <img class="w-100" src="assets/images/course/course-01/course-05.jpg" alt="Course Thumb">
                        </a>
                        <div class="wishlist-top-right">
                          <button class="wishlist-btn"><i class="icon-Heart"></i></button>
                        </div>
                    ...
                    <div class="card-hover-action">
                      <div class="hover-content">
                        ...
                        <h6 class="title"><a href="course-details.html">Java Programming Masterclass for Software
                            Developers</a></h6>
