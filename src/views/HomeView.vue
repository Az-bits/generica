<template>
          ...
          <div class="col-lg-6">
            <div class="banner-image">
              <div class="banner-main-image">
                <img class="landing-banner-hero-img" src="assets/images/banner/landing-demo/tablet-mobile-view.png"
        ...
        <div class="shape-wrapper">
          <div class="shape-dot-wrapper shape-wrapper d-xl-block d-none">
            <div class="shape-image shape-image-1">
              <img src="assets/images/shapes/shape-11-08.png" alt="Shape Thumb" />
            </div>
            <div class="shape-image shape-image-2">
              <img src="assets/images/shapes/shape-03.png" alt="Shape Thumb" />
            </div>
            <div class="shape-image shape-image-3">
              <img src="assets/images/shapes/shape-23-02.png" alt="Shape Thumb" />
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="landing-home-demo-area edu-section-gap bg-color-white" id="demo">
    <div class="container eduvibe-animated-shape">
            ...
            <div class="inner">
              <div class="thumbnail">
                <a class="thumbnail-link" target="_blank" href="index-one.html">
                  <img src="assets/images/landing-demo/home-01.jpg" alt="Preview Images">
                </a>
            ...
            <div class="inner">
              <div class="thumbnail">
                <a class="thumbnail-link" target="_blank" href="index-two.html">
                  <img src="assets/images/landing-demo/home-02.jpg" alt="Preview Images">
                </a>
                <div class="hover-action">
            ...
            <div class="inner">
              <div class="thumbnail">
                <a class="thumbnail-link" target="_blank" href="index-three.html">
                  <img src="assets/images/landing-demo/home-03.jpg" alt="Preview Images">
                </a>
                <div class="hover-action">
            ...
            <div class="inner">
              <div class="thumbnail">
                <a class="thumbnail-link" target="_blank" href="index-four.html">
                  <img src="assets/images/landing-demo/home-04.jpg" alt="Preview Images">
                </a>
                <div class="hover-action">
            ...
            <div class="inner">
              <div class="thumbnail">
                <a class="thumbnail-link" target="_blank" href="index-five.html">
                  <img src="assets/images/landing-demo/home-05.jpg" alt="Preview Images">
                </a>
                <div class="hover-action">
            ...
            <div class="inner">
              <div class="thumbnail">
                <a class="thumbnail-link" target="_blank" href="#">
                  <img src="assets/images/landing-demo/coming-soon.jpg" alt="Preview Images">
                </a>
              </div>
      ...
      <div class="shape-dot-wrapper shape-wrapper d-xl-block d-none">
        ...
        <div class="shape-image shape-image-2">
          <img src="assets/images/shapes/shape-29-01.png" alt="Shape Thumb" />
        </div>
        <div class="shape-image shape-image-3">
          <img src="assets/images/shapes/shape-04-03.png" alt="Shape Thumb" />
        </div>
        <div class="shape-image shape-image-4">
          <img src="assets/images/shapes/shape-16-02.png" alt="Shape Thumb" />
        </div>
      </div>
  ...
  <div class="edu-demo-course-layout edu-section-gap bg-image">
    <div class="container eduvibe-animated-shape">
            ...
            <div class="inner">
              <div class="thumbnail">
                <a class="thumbnail-link" href="course-style-1.html" target="_blank">
                  <img src="assets/images/landing-demo/course-1.jpg" alt="Course 1">
                </a>
              </div>
            </div>
          </div>
            ...
            <div class="inner">
              <div class="thumbnail">
                <a class="thumbnail-link" href="course-style-2.html" target="_blank">
                  <img src="assets/images/landing-demo/course-2.jpg" alt="Course 2">
                </a>
              </div>
            </div>
          </div>
            ...
            <div class="inner">
              <div class="thumbnail">
                <a class="thumbnail-link" href="course-style-3.html" target="_blank">
                  <img src="assets/images/landing-demo/course-3.jpg" alt="Course 3">
                </a>
              </div>
            </div>
          </div>
      ...
      <div class="shape-dot-wrapper shape-wrapper d-xl-block d-none">
        <div class="shape-image shape-image-1">
          <img src="assets/images/shapes/shape-05-06.png" alt="Shape Thumb" />
        </div>
        ...
        <div class="shape-image scene shape-image-3">
          <img src="assets/images/shapes/shape-07-03.png" alt="Shape Thumb" />
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="landing-demo-features edu-section-gap bg-color-white" id="features">
    <div class="container eduvibe-animated-shape">
      ...
      <div class="row g-5 mt--10">
        ...
        <div class="col-lg-3 col-md-4 col-sm-6 col-12" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
          <div class="demo-feature mt--20">
            <div class="inner">
              <div class="icon">
                <img src="assets/images/landing-demo/feature-01.png" alt="Preview Images">
              </div>
        ...
        <div class="col-lg-3 col-md-4 col-sm-6 col-12" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
          <div class="demo-feature mt--20">
            <div class="inner">
              <div class="icon">
                <img src="assets/images/landing-demo/feature-02.png" alt="Preview Images">
              </div>
        ...
        <div class="col-lg-3 col-md-4 col-sm-6 col-12" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
          <div class="demo-feature mt--20">
            <div class="inner">
              <div class="icon">
                <img src="assets/images/landing-demo/feature-03.png" alt="Preview Images">
              </div>
        ...
        <div class="col-lg-3 col-md-4 col-sm-6 col-12" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
          <div class="demo-feature mt--20">
            <div class="inner">
              <div class="icon">
                <img src="assets/images/landing-demo/feature-04.png" alt="Preview Images">
              </div>
        ...
        <div class="col-lg-3 col-md-4 col-sm-6 col-12" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
          <div class="demo-feature mt--20">
            <div class="inner">
              <div class="icon">
                <img src="assets/images/landing-demo/feature-05.png" alt="Preview Images">
              </div>
        ...
        <div class="col-lg-3 col-md-4 col-sm-6 col-12" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
          <div class="demo-feature mt--20">
            <div class="inner">
              <div class="icon">
                <img src="assets/images/landing-demo/feature-06.png" alt="Preview Images">
              </div>
        ...
        <div class="col-lg-3 col-md-4 col-sm-6 col-12" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
          <div class="demo-feature mt--20">
            <div class="inner">
              <div class="icon">
                <img src="assets/images/landing-demo/feature-07.png" alt="Preview Images">
              </div>
        ...
        <div class="col-lg-3 col-md-4 col-sm-6 col-12" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
          <div class="demo-feature mt--20">
            <div class="inner">
              <div class="icon">
                <img src="assets/images/landing-demo/feature-08.png" alt="Preview Images">
              </div>
        ...
        <div class="col-lg-3 col-md-4 col-sm-6 col-12" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
          <div class="demo-feature mt--20">
            <div class="inner">
              <div class="icon">
                <img src="assets/images/landing-demo/feature-09.png" alt="Preview Images">
              </div>
        ...
        <div class="col-lg-3 col-md-4 col-sm-6 col-12" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
          <div class="demo-feature mt--20">
            <div class="inner">
              <div class="icon">
                <img src="assets/images/landing-demo/feature-10.png" alt="Preview Images">
              </div>
        ...
        <div class="col-lg-3 col-md-4 col-sm-6 col-12" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
          <div class="demo-feature mt--20">
            <div class="inner">
              <div class="icon">
                <img src="assets/images/landing-demo/feature-11.png" alt="Preview Images">
              </div>
        ...
        <div class="col-lg-3 col-md-4 col-sm-6 col-12" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
          <div class="demo-feature mt--20">
            <div class="inner">
              <div class="icon">
                <img src="assets/images/landing-demo/feature-12.png" alt="Preview Images">
              </div>
        ...
        <div class="col-lg-3 col-md-4 col-sm-6 col-12" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
          <div class="demo-feature mt--20">
            <div class="inner">
              <div class="icon">
                <img src="assets/images/landing-demo/feature-13.png" alt="Preview Images">
              </div>
        ...
        <div class="col-lg-3 col-md-4 col-sm-6 col-12" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
          <div class="demo-feature mt--20">
            <div class="inner">
              <div class="icon">
                <img src="assets/images/landing-demo/feature-14.png" alt="Preview Images">
              </div>
        ...
        <div class="col-lg-3 col-md-4 col-sm-6 col-12" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
          <div class="demo-feature mt--20">
            <div class="inner">
              <div class="icon">
                <img src="assets/images/landing-demo/feature-15.png" alt="Preview Images">
              </div>
        ...
        <div class="col-lg-3 col-md-4 col-sm-6 col-12" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
          <div class="demo-feature mt--20">
            <div class="inner">
              <div class="icon">
                <img src="assets/images/landing-demo/feature-16.png" alt="Preview Images">
              </div>
      ...
      <div class="shape-wrapper">
        <div class="shape-dot-wrapper shape-wrapper d-xl-block d-none">
          <div class="shape-image shape-image-1">
            <img src="assets/images/shapes/shape-04-08.png" alt="Shape Thumb" />
          </div>
          <div class="shape-image shape-image-2">
            <img src="assets/images/shapes/shape-03-02.png" alt="Shape Thumb" />
          </div>
          <div class="shape-image shape-image-3">
            <img src="assets/images/shapes/shape-11-10.png" alt="Shape Thumb" />
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container eduvibe-animated-shape">
          ...
          <div class="landing-demo-faq edu-accordion-02 variation-2 landing-page-accordion" id="accordionExample1">
            ...
            <div class="edu-accordion-item" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
              <div class="edu-accordion-header" id="headingOne">
                <button class="edu-accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne"
              ...
              <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                ...
                <div class="edu-accordion-body">
                  <p>Looking for an elegant template to build your education website that won’t burden your budget?
                    <strong>"EduVibe - Education HTML Template Using Bootstrap 5"</strong> is the best way to get started
                    with wonderful animations, creative design patterns, and code that is perfectly responsive. This
                    Bootstrap 5 template includes 05 different homepage demos that are easy to customize. Currently we're
                    working on 3 other homepages. There are more than 45+ inner pages designed blocks ready to use in
                    every conceivable educational institution—perfect for distance learning or remote training purposes!
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="edu-accordion-item">
              ...
              <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                data-bs-parent="#accordionExample1">
                <div class="edu-accordion-body">
                  <p>If you already bought <strong>"EduVibe"</strong> then you can open a support ticket at <strong><a
                        href="https://devsvibe.freshdesk.com/" target="_blank">devsvibe.freshdesk.com</a></strong> or you
                    can simply send us an email at <strong><a href="mailto:contact@devsvibe.com"
                        target="_blank">contact@devsvibe.com</a></strong> along with the purchase code. To find the
                    purchase code please follow this <strong><a
                        href="https://help.market.envato.com/hc/en-us/articles/202822600-Where-Is-My-Purchase-Code-"
                        target="_blank">link</a></strong>. Our support engineers will reply to you within 15 minutes to 8
                    hours(max).</p>
                </div>
              </div>
            </div>
            ...
            <div class="edu-accordion-item">
              ...
              <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree"
                data-bs-parent="#accordionExample1">
                <div class="edu-accordion-body">
                  <p>Sure, you can simply send us an email at <strong><a href="mailto:contact@devsvibe.com"
                        target="_blank">contact@devsvibe.com</a></strong> or you can send us a message at <strong><a
                        href="https://m.me/devsvibe" target="_blank">Facebook Messenger</a></strong>.</p>
                </div>
              </div>
            </div>
            ...
            <div class="edu-accordion-item">
              ...
              <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour"
                data-bs-parent="#accordionExample1">
                <div class="edu-accordion-body">
                  <p>If you buy once, then you'll get lifetime updates and you don't need to spend a penny for any further
                    updates. Whenever we add a feature in <strong>EduVibe</strong>, you'll receive all the future updates
                    for free...</p>
                </div>
              </div>
            </div>
            ...
            <div class="edu-accordion-item">
              ...
              <div id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingFive"
                data-bs-parent="#accordionExample1">
                <div class="edu-accordion-body">
                  <p>We've designed and coded <strong>EduVibe</strong> considering the maximum customization ability. We
                    believe you can customize it as you want like any other HTML template. You can also read the in
                    details <strong><a href="https://docs.devsvibe.com/eduvibe-html/index.html"
            ...
            <div class="edu-accordion-item">
              ...
              <div id="collapseSix" class="accordion-collapse collapse" aria-labelledby="headingSix"
                data-bs-parent="#accordionExample1">
                <div class="edu-accordion-body">
                  <p><strong>EduVibe</strong> is an education template specially designed for building a complete website
                    for online course, motivation, photography, school/kindergarten, university or any kind of educational
                    institution.</p>
                </div>
              </div>
            </div>
            ...
            <div class="edu-accordion-item">
              ...
              <div id="collapseSeven" class="accordion-collapse collapse" aria-labelledby="headingSeven"
                data-bs-parent="#accordionExample1">
                <div class="edu-accordion-body">
                  <p>We provide custom solutions as a service. If you're searching for a developer to customize your
                    template according to your requirements or any other custom work then please feel free to contact with
                    us at <strong><a href="mailto:contact@devsvibe.com" target="_blank">contact@devsvibe.com</a></strong>
                  </p>
                </div>
              </div>
            </div>
      ...
      <div class="shape-dot-wrapper shape-wrapper d-xl-block d-none">
        <div class="animate-image shape-image-1">
          <img src="assets/images/shapes/shape-11-11.png" alt="Shape Thumb">
        </div>
        <div class="animate-image shape-image-2">
          <img src="assets/images/shapes/shape-14-01.png" alt="Shape Thumb">
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="row row--50 align-items-center">
        <div class="col-lg-6 col-lg-offset-1">
          <div class="pre-section-title text-start">
            ...
            <p class="description mt--40">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec nunc null
              liobortis nibh porttitor. Facilisi arcu, nibh vel risus, morbi pharetra. Facilisi sit miam mauris non
              iaculis elit fusce amet nunc in odio molestie.</p>
        ...
        <div class="col-lg-5">
          <div class="thumbnail">
            <img src="assets/images/landing-demo/ecommerce-support.png" alt="Shop Images">
          </div>
        </div>
      </div>
      <div class="shape-dot-wrapper shape-wrapper d-xl-block d-none">
        ...
        <div class="shape-image shape-image-2">
          <img src="assets/images/shapes/shape-05-03.png" alt="Shape Thumb">
        </div>
        <div class="shape-image shape-image-3">
